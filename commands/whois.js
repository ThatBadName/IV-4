...
module.exports = {
    ...
    callback: async({interaction}) => {
        ...
        if(interaction.options.getUser('user')) {
            ...
            .addField('ID', `\`${user.id}\``)
            .addField('Account Created', `${moment.utc(user.createdAt).format('ddd, MMM Do, YYYY, h:mm a')}`)
            .addField('Joined Server', `${moment.utc(user.joinedAt).format('ddd, MMM Do, YYYY, h:mm a')}`)
